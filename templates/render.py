...
if __name__ == '__main__':
  ...
  home_html = base_template.render(content=home_html, tab='home')
  ...
  research_html = base_template.render(content=research_html, tab='research')
  ...
  teaching_html = base_template.render(content=teaching_html, tab='teaching')
